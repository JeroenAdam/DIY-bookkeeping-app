...
<?php
	...
	include('./include/datums.inc.php');
		...
		$query = "SELECT id, klantnummer, datum, totaalincl FROM `facturen` ORDER BY id DESC";
		$sql = mysql_query($query) or die ( mysql_error( ) );

		echo "<br><table CLASS=\"opmaak\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" colspan = \"9\" border=\"0\" bgcolor=\"#E9E9E9\" width=\"40%\">";
		echo "\n<tr bgcolor=\"#DAE2E4\"><td width=45><b>Fact#</b></td><td width=250><b>Klantnaam</b></td><td><b>Datum</b></td><td width=80 align=right><b>Totaal incl.</b></td><td bgcolor=\"white\"></td></tr><tr><td></td><td></td><td></td><td></td><td bgcolor=\"white\"></td></tr>";
		$i=0;
		while($record = mysql_fetch_array($sql))
		  {  $i=$i+1; $cBgColor = "#E9E9E9";
			...
			echo "&nbsp;€</td><td bgcolor=\"white\">&nbsp;&nbsp;&nbsp;<a href=\"aftedrukkenfactuur.php?id=$record[id]\"><img src= \"images/print.bmp\" border=\"0\"></a></td></tr>";
		}
		echo "\n</table>";
